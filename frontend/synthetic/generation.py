...
def get_competency_levels(competency_ids: List[int],
                  department_ids: List[int]) -> List[CompetencyLevel]:
...
def get_employee_departments(department_ids: List[int], employee_ids: List[int]) -> List[EmployeeDepartmentWithoutDates]:
...
def get_employee_competencies(employee_ids: List[int], competency_ids: List[int]) -> List[EmployeeCompetencyWithoutDates]:
