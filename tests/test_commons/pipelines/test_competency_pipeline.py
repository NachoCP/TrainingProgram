...
competency_level_company = [
    CompetencyLevelOutput(name=competency_creative_expression, required_level=RequiredLevelEnum.advanced, num_workers=2)
]

competency_level_company_full = [
    CompetencyLevelOutput(
        name=competency_creative_expression, required_level=RequiredLevelEnum.advanced, num_workers=2
    ),
    CompetencyLevelOutput(name=competency_machine_learning, required_level=RequiredLevelEnum.advanced, num_workers=2),
]
...
competency_level_department = [
    CompetencyLevelOutput(name=competency_creative_expression, required_level=RequiredLevelEnum.basic, num_workers=2),
    CompetencyLevelOutput(name=competency_machine_learning, required_level=RequiredLevelEnum.basic, num_workers=2),
]
...
def test_competency_pipeline_rules():
    pipeline = CompetencyPipeline(competencies)
    priority = pipeline.transform([], competency_level_company, competency_level_department, competency_employee)
...
def test_competency_pipeline_rules_non_priority():
    ...
    priority = pipeline.transform(
        [], competency_level_company, competency_level_department, competency_employee_advanced
    )
...
def test_competency_pipeline_rules_non_priority_company_requirements():
    pipeline = CompetencyPipeline(competencies)
    priority = pipeline.transform(
        [], competency_level_company, competency_level_department_matching, competency_employee
    )
...
def test_competency_pipeline_full():
    pipeline = CompetencyPipeline(competencies)
    priority = pipeline.transform(
        feedbacks, competency_level_company_full, competency_level_department, competency_employee
    )
