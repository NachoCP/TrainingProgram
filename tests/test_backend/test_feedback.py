...
def test_success_create_entity_object(test_get_db) -> None:
    ...
    entity_model_def = Feedback(
        id=1, employee_id=1, feedback_by=2, comments="I liked more the Grey one", score=3.1, effective_date="2024-01-01"
    )
...
def test_success_bulk_entity_object(test_get_db) -> None:
    ...
    list_entity_model_def = [
        Feedback(
            ...
            employee_id=1,
            feedback_by=2,
            comments="I liked more the Grey one",
            score=3.1,
            effective_date="2024-01-01",
        ),
        Feedback(
            id=2, employee_id=1, feedback_by=3, comments="I is a good guy", score=5.0, effective_date="2024-01-02"
        ),
    ]
    repository = FeedbackRepository(test_get_db)
