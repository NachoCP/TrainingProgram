...
SYSTEM_MESSAGE_SYNTHETIC = (
    "You are a world class AI that excels at generating synthetic data."
    "Make sure to create the perfect number of entities"
)
SYSTEM_MESSAGE_COURSE = (
    "You are a world class AI that excels at identifying topics in text description"
...
SYSTEM_MESSAGE_COMPETENCY = (
    "You are a world class AI that excel at detecting competencies to be improve by a person"
