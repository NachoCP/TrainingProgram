...
class Feedback(BaseModel):
    ...
    feedback_by: int = Field(
        ...,
        description="Unique identifier for the person giving the feedback (peer, subordinate, or superior)",
        example=2001,
    )
    comments: str = Field(
        ...,
        description="Textual feedback describing the performance of the employee",
        example="Great teamwork and leadership shown during the project.",
    )
